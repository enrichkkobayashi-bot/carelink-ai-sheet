        ...
        <div className="w-64 bg-gray-900 text-white flex-shrink-0 flex flex-col shadow-xl z-20">
          ...
          <div className="p-4 border-t border-gray-800">
            <div className="flex items-center space-x-3 px-2 py-2 rounded-lg bg-gray-800/50 cursor-pointer hover:bg-gray-800 transition-colors">
              <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-purple-500 flex items-center justify-center text-xs font-bold text-white ring-2 ring-gray-700">CM</div>
              <div className="overflow-hidden">
                <div className="text-sm font-bold text-white truncate">鈴木 太郎</div>
                <div className="text-xs text-gray-400 truncate">ケアマネージャー</div>
              </div>
            </div>
          </div>
        </div>
